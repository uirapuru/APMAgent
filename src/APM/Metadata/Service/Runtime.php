...
namespace APM\Metadata\Service;
 ...
 * @method static Runtime|null import($data, Context $options = null)
 */
class Runtime extends ClassStructure
{
    /** @var string|null */
    public $name;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Name and version of the language runtime running this service";
    }
