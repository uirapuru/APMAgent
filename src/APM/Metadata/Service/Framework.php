 ...
 * @method static Framework|null import($data, Context $options = null)
 */
class Framework extends ClassStructure
{
    /** @var string|null */
    public $name;
    ...
    public static function setUpProperties($properties, Schema $ownerSchema)
    {
        ...
        $ownerSchema->description = "Name and version of the web framework used";
    }
